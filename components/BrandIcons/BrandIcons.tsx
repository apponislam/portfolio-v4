        ...
        case "next.js 14 (app router)":
            return (
                <svg className={className} viewBox="0 0 180 180" fill="none">
                    <mask id="next-mask-brand" maskUnits="userSpaceOnUse" x="0" y="0" width="180" height="180">
                        <circle cx="90" cy="90" r="90" fill="black" />
                    </mask>
                    <g mask="url(#next-mask-brand)">
                        <circle cx="90" cy="90" r="90" fill="black" />
                        <path d="M149.508 157.52L69.142 54H54V125.97H66.1136V69.344L137.492 160.628C141.745 159.709 145.761 158.643 149.508 157.52Z" fill="url(#next-grad-brand)" />
                        <rect x="115" y="54" width="12" height="72" fill="url(#next-grad-brand)" />
                    </g>
                    <defs>
                        <linearGradient id="next-grad-brand" x1="109" y1="116.5" x2="144.5" y2="160.5" gradientUnits="userSpaceOnUse">
